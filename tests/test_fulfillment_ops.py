...
class FulfillmentOpsTests(unittest.TestCase):
    ...
    def test_remote_reconcile_via_whop_api(self):
        ...
        payment = {
            "id": "pay_remote_1", "status": "paid",
            "metadata": {"neural_order_id": "ng_remote_1", "telegram_id": "210", "plan_days": "7", "source": "neural_gold"},
            "plan": {"id": "plan_ksl11weFJ0z41"}, "membership": {"id": "mem_remote_1"},
        }
    ...
    def test_webhook_self_heals_after_db_wipe(self):
        payment = {
            ...
            "metadata": {"neural_order_id": "ng_wiped_1", "telegram_id": "213", "plan_days": "7", "source": "neural_gold"},
            "plan": {"id": "plan_ksl11weFJ0z41"}, "membership": {"id": "mem_w1"},
        }
